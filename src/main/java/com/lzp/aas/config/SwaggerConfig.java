...
@EnableSwagger2
@Configuration
@ComponentScan(basePackages = "com.lzp.aas")
public class SwaggerConfig {

    private static ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Asset accounting system API")
                .description("Asset accounting system API")
                .license("")
                .licenseUrl("")
                .termsOfServiceUrl("")
                .version("0.2").build();
    ...
    @Bean
    Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("AAS API")
                .apiInfo(apiInfo())
